    ...
    if payload != 0:
        try:
            if payload['permission']['update']:
                ...
                update_tuple = (request_body[REQ_WELDER_MACHINE_MAPPING_WELDERID],
                                request_body[REQ_WELDER_MACHINE_MAPPING_MACHINEID], entity_id)
                # Parameterized update query
                data, err = django_parameterized_query_update(update_sql=modifyWelderMachineMapping_query,
