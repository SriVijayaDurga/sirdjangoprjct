    ...
    if payload != 0:
        try:
            if payload['permission']['delete']:
                ...
                data, err = django_parameterized_query_multiple_delete(delete_sql=welder_delete_query,
                                                                       delete_tuple=delete_tuple)
                print(data)
                data, err = django_parameterized_query_multiple_delete(delete_sql=welderMappingDelete_query,
                                                                       delete_tuple=delete_tuple)
                if data == 0:
