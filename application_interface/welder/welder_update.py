    ...
    if payload != 0:
        try:
            if payload['permission']['update']:
                ...
                update_tuple = (str(request_body[REQ_WELDER_FIRSTNAME]),
                                ...
                                request_body[REQ_WELDER_GENDER], request_body[REQ_WELDER_ID], entity_id)
                # Parameterized update query
                data, err = django_parameterized_query_update(update_sql=welder_update_query,
