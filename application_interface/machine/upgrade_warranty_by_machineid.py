...
def upgrade_warranty(request, machineid):
    print("method")
    """
    ...
    if payload != 0:
        try:
            if payload['permission']['update']:
                ...
                update_tuple = (request_body[REQ_WARRANTY_EXPITYDATE], machineid, entity_id)
                # Parameterized update query
                data, err = django_parameterized_query_update(update_sql=upgrade_warranty_query,
