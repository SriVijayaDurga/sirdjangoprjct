...
def update_node(request, nodeaddr):
    """
    ...
    if payload != 0:
        try:
            if payload['permission']['update']:
                ...
                update_tuple = (str(request_body[REQ_GATEWAYMAC_ID]), request_body[REQ_NODE_COMMISSION],
                                nodeaddr, entity_id)
                # Parameterized update query
                data, err = django_parameterized_query_update(update_sql=updateNode_query,
